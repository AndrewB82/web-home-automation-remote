<!-- PHP proxy script to communicate with Fibaro Home Center 2. Fibaro supposedly enables REST API for its HC2, 
but due to cross-domain requests issue I did not figue out how to reach it directly. It works, however through the proxy 
...
if ( !$url ) {
  ...
  //AMENDMENT: below 2 lines are added - Fibaro HC2 credentials:
  $credentials = "<Fibaro HC2 login>:<Fibaro HC2 password>";
