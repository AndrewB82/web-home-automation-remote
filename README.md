...
## RFXtrx433E transceiver - when there is no Domoticz server
...
For my needs only Lighting4 and Lighting5 protocols are enabled in RFXmngr app.
...
For the project, I used HA bridge for:
